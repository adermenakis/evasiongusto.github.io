...
const translations = {
    ...
    fr: {
        ...
        introDesc: "Basés à Beaumont, nous intervenons dans toute la province du Hainaut : Beaumont, Chimay, Mons, Sivry, Rance, Thuin, Charleroi, Froidchapelle, Solre-sur-Sambre, la zone SHAPE OTAN, et les communes environnantes. Nous nous déplaçons également à Bruxelles, Namur et d'autres villes belges pour des événements spéciaux (des frais de déplacement supplémentaires peuvent s'appliquer selon la distance et le type d'événement). Découvrez nos services premium : chef à domicile pour vos repas privés, traiteur professionnel pour événements, plats à emporter gastronomiques, cours de cuisine interactifs, dégustations de vins et bières, et ateliers culinaires de team building. Notre collaboration avec des producteurs locaux garantit des ingrédients frais et une qualité exceptionnelle—le tout à prix abordable.",
        ...
        service5Desc: "Développez vos compétences culinaires avec nos cours de cuisine et ateliers culinaires interactifs à Beaumont et dans toute la région du Hainaut. De la maîtrise des techniques à l'exploration de nouvelles recettes, nous vous accompagnons à chaque étape. Que vous soyez débutant souhaitant acquérir les bases ou cuisinier expérimenté cherchant à perfectionner vos techniques, nos cours de cuisine pratiques offrent un apprentissage ludique et engageant. Disponibles à Beaumont, Chimay, Mons, Charleroi, et nous organisons également des cours à Bruxelles. Découvrez le plaisir de cuisiner et repartez avec le savoir-faire pour impressionner vos proches.",
